...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def get_image_url(self, obj):
        ...
        if settings.USE_S3_STORAGE:
            # django-storages' S3Storage already returns a full, correct,
            # browser-reachable URL (the bucket's S3 URL, or the CloudFront
            # domain if AWS_S3_CUSTOM_DOMAIN is set) - no prefixing needed.
